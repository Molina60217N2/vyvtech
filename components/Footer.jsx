              ...
              <li>
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 30 30"
                    fill="none"
                    style={hoverFacebook ? {filter: "drop-shadow(0px 0px 10px rgb(235,235,235,235))",transitionDuration: "300ms", transitionTimingFunction: "ease-in-out"} : {filter: "none"}}
                  ...
                  >
                    <g clip-path="url(#clip0_42_181)">
                      <path
                        ...
                        className={hoverFacebook ? "fill-[#09385F] duration-300 ease-out"  : "fill-white duration-300 ease-out"}
                      />
                      <path
                        ...
                        className={hoverFacebook ? "fill-white duration-200 ease-out" : "fill-[#105A8B] duration-200 ease-out"}
                      />
                    </g>
                    <defs>
              ...
              <li>
                ...
                >
                  <svg
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    style={hoverWhatsApp ? {filter: "drop-shadow(0px 0px 10px rgb(37,211,102))", transitionDuration: "300ms", transitionTimingFunction: "ease-in-out"} : {filter: "none"}}
                  >
                    <g clip-path="url(#clip0_42_184)">
                      <path
                        ...
                        className={hoverWhatsApp ? "fill-[#25d366] ease-in-out duration-300" : "fill-[#E5E5E5] ease-in-out duration-300"}
                      />
                      <path
                        ...
                        className={hoverWhatsApp ? "fill-[#25d366] ease-in-out duration-300" : "fill-white ease-in-out duration-300"}
                      />
                      <path
                        ...
                        fill="#0F5C9A"
                        className={hoverWhatsApp ? "fill-[#075e54] ease-in-out duration-300" : "fill-[#0F5C9A] ease-in-out duration-300"}
                      />
                      <path
                        d="M0.696899 29.3617L2.71656 21.9864C1.47075 19.8278 0.81546 17.3793 0.816376 14.8707C0.81958 7.02307 7.20585 0.638428 15.0533 0.638428C18.8614 0.64003 22.4359 2.12226 25.1239 4.81253C27.8117 7.5028 29.2914 11.0788 29.29 14.8822C29.2866 22.7296 22.8994 29.1151 15.0533 29.1151C15.0528 29.1151 15.0535 29.1151 15.0533 29.1151H15.0471C12.6645 29.1142 10.3235 28.5166 8.24406 27.3825L0.696899 29.3617ZM8.59356 24.806L9.02592 25.0621C10.8423 26.1401 12.9249 26.7103 15.0487 26.7114H15.0533C21.5751 26.7114 26.8833 21.4041 26.8861 14.8812C26.8872 11.7202 25.6576 8.74769 23.4235 6.51175C21.1892 4.27581 18.2185 3.04374 15.0577 3.04237C8.53062 3.04237 3.22261 8.34898 3.2201 14.8716C3.21918 17.1069 3.84449 19.2836 5.02918 21.1672L5.31071 21.6149L4.11503 25.9802L8.59356 24.806Z"
                        className={hoverWhatsApp ? "fill-[#25d366] ease-in-out duration-300" : "fill-white ease-in-out duration-300"}
              ...
              <li className="my-auto">
                ...
                >
                  <svg
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    style={hoverEmail ? {filter: "drop-shadow(0px 0px 10px rgb(227, 120, 106))", transitionDuration: "300ms", transitionTimingFunction: "ease-in-out"} : {filter: "none"}}
                  >
                    <path
                      ...
                      className={hoverEmail ? "fill-[#dd4b39] ease-in-out duration-300" : "fill-white ease-in-out duration-300"}
                    />
                  </svg>
                </Link>
              </li>
